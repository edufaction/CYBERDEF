...
sharp corners, 
  ...
  coltitle = ocre!20!black,
  fonttitle = \bfseries, 
  title    =  {\textcolor{ocre}{\faFile~\small {Sujet de mémoire SECOPS}}} : #2,
  #1,
}
...
% MODIFICATIOn POUR HMTL (icon.png )
%TODO : HTML Toolbox à modifier

\newcommand{\toolsbox}[2]
{
\input{Tex/SecComponents/#2.#1/datas.tex} 
\begin{toolsboxin}[sidebyside,righthand width=.7\textwidth]{#1}
%\includegraphics[width=0.9\textwidth]{Tex/SecComponents/#2.#1/icon.png} \\
\tcblower
\input{Tex/SecComponents/#2.#1/description.tex}
\end{toolsboxin}
\noindent \small {\faCogs~Classe : \uppercase{\textbf{#2}}, Site de référence : \textbf{\link{\toolurl}{#1}}}
\newline
...
%\begin{figure}[!h] %h
  \begin{center}
	 \includegraphics[height=0.95\textheight, width=0.95\textwidth, keepaspectratio ]{#1.\upictureext}
  \end{center}
%  \end{figure}
}
...
\begin{figure}[!hbtp] %h !hbtp
  \begin{center}
	 \includegraphics[width=#3\textwidth]{#1.\upictureext}
  \end{center}
\caption{#2 \label{#4}}
\end{figure}
}
...
%\newcommand{\upicture}[4]{\ulpicture{#1.\upictureext}{#2}{#3}{#4}}
...
\centering \includegraphics[width=#3\textwidth]{#1.\upictureext}
\caption{#2 \label{#4}}
\end{figure}
}
\fi
...
\providecommand{\picframeS}[4]
{
\begin{frame}
\frametitle<presentation>{#2}
  \begin{center}
	 \includegraphics[height=0.95\textheight, width=0.95\textwidth, keepaspectratio ]{\picpath/img-#1.\upictureext}
  \end{center}
\end{frame}
...
{
\begin{figure}[!hbtp] % !hbtp ou !h 
\centering \includegraphics[width=#3\textwidth]{\picpath/img-#1.\upictureext}
\caption{(s) #2 \label{#4}}
\end{figure}
}
\fi
...
\newcommand{\uref}[2]{(Voir #1 en ref #2)}
...
\begin{wrapfigure}{R}{#3\textwidth}
  \begin{center}
	 \resizebox{#3\textwidth}{!}{\includegraphics{#1.\upictureext}}
  \end{center}
\caption{#2}
\end{wrapfigure}
}
...
%-----------------------------------------------------  
  ...
  { \href{https://fr.wikipedia.org/wiki/#1}{\textcolor{grey}{#1}}\raisebox{0.5ex}{\tiny{\textcolor{ocre}{\faWikipediaW}}}}
