...
% end header PRZ======================
\upicture{Tex/Pictures/img-thinkrun}{les phases du cycle de vie}{0.7}{lblthinkrun}
...
\upicture{Tex/Pictures/img-cyclevie-pol-strat}{Positionnement de la sécurité opérationnelle}{0.9}{lblpol-strat}
...
\frametitle<presentation>{3 volets d'une cyberdéfense}
% end header PRZ======================
\upicture{Tex/Pictures/img-triangle}{Des 3 des volets de la sécurité opérationnelle}{0.6}{lbltriptyque}
...
\upicture{Tex/Pictures/img-vti}{Les différentes actions de veille}{0.9}{lblvti}
...
\upicture{Tex/Pictures/img-nist}{modèle NIST}{0.9}{lblnist}
\end{frame}
% end PRZ==========================
...
\upicture{Tex/Pictures/img-risk27}{modèle ISO27 et risques}{0.9}{lblrisk27}
\end{frame}
% end PRZ==========================
...
% end header PRZ =======================
\upicture{Tex/Pictures/img-chapvar}{Synthèse des méta-processus SECOPS}{0.8}{lblprosecops}
...
% end header PRZ =======================
\upicture{Tex/Pictures/img-metiersVTI}{Des métiers SECOPS}{1}{lblmetiersVTI}
\end{frame}
% end PRZ ===========================
