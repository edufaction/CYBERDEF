...
% end header PRZ =======================
\upicture{Tex/Pictures/img-vul-process}{La gestion des vulnérabilités}{01}{lblvulprocess}
\end{frame}
% end PRZ ===========================
...
% end header PRZ =======================
\upicture{Tex/Pictures/img-vul-patchtimeideal}{Fenêtre d'exposition idéale}{01}{lblvulpatchtimeideal}
\end{frame}
% end PRZ ===========================
...
% end header PRZ =======================
\upicture{Tex/Pictures/img-vul-patchtime}{Fenêtre d'exposition}{01}{lblvulpatchtime}
\end{frame}
% end PRZ ===========================
...
% end header PRZ =======================
\upicture{Tex/Pictures/img-vulsearch}{Rechercher ses vulnérabilités}{1}{lblvulcycle}
\end{frame}
% end PRZ ===========================
