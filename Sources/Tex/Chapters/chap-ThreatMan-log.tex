...
\mode<all>{\picframe{Tex/Pictures/img-log}{Sources de log}{0.7}{lbllog}}
...
\mode<all>{\picframe{Tex/Pictures/img-logman}{Les logs au coeur de la détection}{0.9}{lbllogman2}}
...
\mode<all>{\picframe{Tex/Pictures/img-log-level}{Les niveaux d'outillage}{0.7}{lblloglevel}}
