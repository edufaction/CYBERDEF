...
\mode<all>{\picframe{Tex/Pictures/img-cycle}{Cycle de vie de gouvernance Cyberdef}{0.8}{lblcycle1}}
...
\mode<all>{\picframe{Tex/Pictures/img-var}{Un modèle de gestion cyberdéfense}{0.7}{lblthreatman}}
...
\mode<all>{\picframe{Tex/Pictures/img-threatrosas}{les 4 axes de la gestion de la menace}{0.5}{lblthreatrosas}}
...
\mode<all>{\picframe{Tex/Pictures/img-varmenaces}{la gestion active de la menace}{0.5}{lblvarmenaces}}
...
\mode<all>{\picframe{Tex/Pictures/img-threatwheel}{la gestion de la menace}{0.8}{lblthreatwheel}}
...
\mode<all>{\picframe{Tex/Pictures/img-logman}{la gestion de la menace}{0.8}{lbllogman}}
