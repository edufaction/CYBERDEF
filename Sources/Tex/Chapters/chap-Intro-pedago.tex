...
\mode<all>{\picframe{Tex/Pictures/img-metiers}{les  grands domaines de métiers}{0.9}{lblmetiers}}
...
\mode<all>{
\picframe{Tex/Pictures/img-metiers-risk2crisis}
...
\mode<all>{\picframe{Tex/Pictures/img-metierslist}{les métiers dans le cycle de vie}{0.9}{lblmetiersall}}
