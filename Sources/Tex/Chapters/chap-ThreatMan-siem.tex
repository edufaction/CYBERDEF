...
\mode<all>{\picframe{Tex/Pictures/img-siem}{architecture d'un SIEM}{0.8}{lblsiem}}
...
\mode<all>{\picframe{Tex/Pictures/img-siem-method}{Cadre méthodologique}{0.8}{lblsiemmethod}}
...
\mode<all>{\picframe{Tex/Pictures/img-siem-usecase}{Construction des UseCase}{1}{lblsiemusecase}}
