...
% end header PRZ =======================
\upicture{Tex/Pictures/img-hot}{les types de vulnérabilités}{0.6}{lblvulhot}
\end{frame}
% end PRZ ===========================
...
% end header PRZ =======================
\upicture{Tex/Pictures/img-vul-types}{Les types de vulnérabilités}{1}{lblvultypes}
\end{frame}
% end PRZ ===========================
...
\upicture{Tex/Pictures/img-smbfaille}{Tempo faille SMB - google}{0.6}{lblfaillesmb}
...
% end header PRZ =======================
\upicture{Tex/Pictures/img-zerodium}{Le marché des failles mobiles avec Zerodium}{0.6}{lblzerodium}
\end{frame}
% end PRZ ===========================
