...
\upicture{Tex/Pictures/img-crypto1}{Exemple d'une encapsulation asymétrique pour un chiffrement de fichier}{0.6}{lblcrypto1}
...
\upicture{Tex/Pictures/img-crypto2}{ Les briques à vérifier dans la chaine de confiance}{0.6}{lblcrypto2}
