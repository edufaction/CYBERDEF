...
\upicture{Tex/Pictures/img-intelligence}{Les axes du renseignement cyber}{0.5}{lblintelligence}

\subsection{VTI(Vulnerabilty/Threat/Incident)}

\upicture{Tex/Pictures/img-VTIsimple}{Les axes du renseignement cyber}{0.7}{lblVTIsimple}
...
\upicture{Tex/Pictures/img-fusioncenter}{Fusion Center et CSOC}{0.7}{lblfusioncenter}
...
\upicture{Tex/Pictures/img-range}{Entrainement}{0.8}{lblrange}
