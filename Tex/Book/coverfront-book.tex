...
\node at (current page.center)  [xshift=0cm, yshift=6cm, text opacity=1.0]  { \includegraphics[width=0.2\paperwidth]{\upath/Template.inc/BookModel/BookPictures/shield-20-white.pdf}} ; 
