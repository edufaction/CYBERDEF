...
% Begin PRZ ===========================
\begin{frame}
\frametitle<presentation>{SIEM}
% end header PRZ =======================
\upicture{../Tex/Pictures/img-siem}{architecture d'un SIEM}{0.9}{lbl-siem}
\end{frame}
% end PRZ ===========================
...
\frametitle<presentation>{SIEM}
% end header PRZ =======================
\upicture{../Tex/Pictures/img-siem-method}{Cadre méthodologique}{1}{lbl-siemmethod}
\end{frame}
% end PRZ ===========================
...
\frametitle<presentation>{SIEM}
% end header PRZ =======================
\upicture{../Tex/Pictures/img-siem-usecase}{Construction des UseCase}{1}{lbl-siemusecase}
\end{frame}
% end PRZ ===========================
...
C'est souvent les équipes "Hunters" assure le maintien du contact entre la défense et les attaquants lors d'une attaque en cours.
...
\begin{itemize}
  \item Celle travaillant autour de l'environnent, de la surface d'attaque et qui oriente ses actions sur des méthodes de "recherches" permettant de débusquer des menaces latentes ou des menaces dormantes et les réveiller et de les suivre de les comprendre et Pour établir le contact avec l'attaquant.
...
Grace à la visualisation  globale des liens il sera possible comprendre où, comment, pourquoi et potentiellement par qui (hactivistes, anciens employés, fournisseurs, etc.) la prochaine attaque pourrait être perpétrée. 
