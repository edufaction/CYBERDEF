...
% $theme : SIEM
% $File : chap-Vulman-siem.tex
%********************************************
\uchap{chap-Vulman-siem.tex}
%********************************************
...
\subsubsection {De l'usage d'un SIEM pour la gouvernance}  
...
\mode<all>{\picframe{../Tex/Pictures/img-siem-method}{Cadre méthodologique}{0.5}{lbl-siemmethod}}
...
\subsubsection{Construire les règles (UseCase)}
...
C'est souvent les équipes \g{Hunters} assure le maintien du contact entre la défense et les attaquants lors d'une attaque en cours.
...
\begin{itemize}
  \item Celle travaillant autour de l'environnent, de la surface d'attaque et qui oriente ses actions sur des méthodes de \g{recherche} permettant de débusquer des menaces latentes ou des menaces dormantes et les réveiller et de les suivre de les comprendre et Pour établir le contact avec l'attaquant.
...
La méthode de \g{hunter} consiste en premier à dresser un portrait global de la surface d’attaque, tout en identifiant les attaquants potentiels, leurs motifs et leurs façons de faire. Plus précisément, le « threat hunting » consiste en une analyse détaillée de différents éléments :
