...
On peut citer le célèbre \textbf{\link{https://haveibeenpwned.com}{';--have i been pwned?}} qui indique si une adresse email utilisée comme identifiant de compte a été compromise lors d'un vol de données sur un site. 
...
L'entrainement est une solution pour dynamiser les activités de cyberdéfense.
