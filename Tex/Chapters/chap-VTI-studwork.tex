...
\begin{itemize}
  ...
  \item Présence et affichage de votre point de vue : Apports personnels : apports liés à votre propre expérience
\end{itemize}
...
%----------------------------------------------------
\subsubsection{Description d'un contre attaque DDOS}
