...
\subsection{Fenêtre d'exposition}
...
\subsection{Processus d’évaluation des vulnérabilités (Vulnerability Assessement)}
...
\begin{itemize}
	...
	\item les audits techniques et pentest, qui peuvent se baser en premier lieu sur des scans pour identifier les vulnérabilités connues, mais qui travaille aussi sur la recherche de vulnérabilités.
\end{itemize}
...
\subsubsection{Audit Organisationnel}
