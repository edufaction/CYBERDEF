...
\upicture{../Tex/Pictures/img-4model}{Cybersécurité : un domaine hollistique}{0.9}{lb_4model}
...
\upicture{../Tex/Pictures/img-cycle3}{Processus Cyber d'entreprise}{0.9}{lbl-processus}
La figure \ref{lbl-processus} présente la dynamique avec laquelle nous avons structuré dans c\edoc.
\end{frame}
% end PRZ====================
...
\begin{itemize}
 ...
 \item \tb{Défendre} les actifs les plus sensibles de l'entreprise en surveillant et combatant la menace (y compris l'image de l'entreprise);
...
% I M A G E -----------> 
\upicture{../Tex/Pictures/img-risk-assess}{le cyber-risque}{0.9}{lbl-riskassess}
...
% I M A G E -----------> 
\upicture{../Tex/Pictures/img-risk-prison}{La menace : une vision de l'attaquant}{0.9}{lbl-riskjail}
...
\item \head{L'audit et le contrôle} : Au sein des grandes organisations, il peut exister un service "indépendant" dont la mission est d'auditer et de contrôler les activités des services;
...
Dans notre contexte d'activité économique dense et en perpétuel renouvellement, les conditions de sécurité sont en perpétuelle évolution, c’est pourquoi on parle d'un cycle de vie vertueux au cours duquel les nouveaux paramètres tirent profit des expériences passées.  Ainsi, l’amélioration continue également appelée \g{ lean management} dans d’autres domaines (industrie, …) travaille-t-elle sur le cycle de vie des conditions de sécurité souvent appelé PDCA pour Plan, Do, Check, Act (roue de Deming).\\
...
\upicture{../Tex/Pictures/img-cyclevie}{Cycle de vie sécurité dans les projets}{0.9}{lbl-cycledevie}
