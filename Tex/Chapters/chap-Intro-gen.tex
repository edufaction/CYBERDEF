...
\section{les 3 axes d'une cybersécurité intégrée}
...
\upicture{../Tex/Pictures/img-cycle3}{Processus Cyber d'entreprise}{0.4}{lbl_processus}
...
% begin PRZ====================
\begin{frame}{Une définition de la cybersécurité}
\begin{align}
Cybers\acute{e}curit\acute{e} \cong Cyberprotection\oplus Cyberd\acute{e}fense \oplus Cyberr\acute{e}silience
\end{align}
\end{frame}
...
% I M A G E -----------> 
\upicture{../Tex/Pictures/img-risk-assess}{le cyber-risque}{0.4}{lbl_riskassess}
...
% I M A G E -----------> 
\upicture{../Tex/Pictures/img-risk-prison}{La menace : une vision de l'attaquant}{0.4}{lbl_riskjail}
...
\upicture{../Tex/Pictures/img-cyclevie}{Cycle de vie sécurité dans les projets}{0.7}{lbl_cycledevie}
