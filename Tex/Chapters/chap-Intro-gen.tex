...
\upicture{../Tex/Pictures/img-cycle3}{Processus Cyber d'entreprise}{0.9}{lbl_processus}
...
% I M A G E -----------> 
\upicture{../Tex/Pictures/img-risk-assess}{le cyber-risque}{0.9}{lbl_riskassess}
...
% I M A G E -----------> 
\upicture{../Tex/Pictures/img-risk-prison}{La menace : une vision de l'attaquant}{0.9}{lbl_riskjail}
...
\upicture{../Tex/Pictures/img-cyclevie}{Cycle de vie sécurité dans les projets}{0.9}{lbl_cycledevie}
