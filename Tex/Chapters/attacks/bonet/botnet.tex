...
\newline
Les premières dérives furent notamment l'affrontement de botnet IRC (\link{https://www.eggheads.org/}{Eggdrop} en décembre 1993, puis GTbot en avril 1998).
...
Au même titre que la protection contre les malwares, les recommandations en terme de SSI\link{https://www.ssi.gouv.fr/administration/bonnes-pratiques/}{recommandations ANSSI}, applicables localement, doivent s'inscrire dans nos habitudes et augmentent ainsi la probabilité de bloquer l'étape initiale de l'infection (spam, navigation non-sécurisée,etc.).
\newline Les mises à jour logicielles et système sont essentielles pour bloquer l'exploitation de CVE\footnote{Common Vulnerabilities and Exposures} \link{https://www.cvedetails.com}{Common Vulnerabilities and Exposures}.
