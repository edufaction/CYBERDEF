...
Après avoir construit une structure sécurité cohérente sur les aspects gestion des flux, gestion des accès et des identités, et construit une gouvernance efficace sur la base de l'ISO27001, il est nécessaire maintenant de maintenir le niveau de sécurité de l'entreprise ou du système.
...
\upicture{../Tex/Pictures/img-thinkrun}{les phases du cycle de vie}{1}{lbl_thinkrun}

Il nous reste donc à aborder la dernière phase du cycle de vie : les activités d'exploitation de la sécurité, \textbf{RUN} : Des évènements de sécurité gérés à une \textbf{cybercrise} maitrisée, que que certains appellent \textbf{SECOPS} : \g{Sécurité Opérationnelle}.


Ce modèle se développe bien entendu en fonction des finalités de l'entreprise.

\begin{itemize}
    \item Soit nous sommes dans une entreprise et ces processus sont ceux mis en place pour s'assurer que  l'ensemble de actions sont prises pour maitriser   ses vulnérabilités, détecter les menaces, et réagir pour maintenir l'activité.
...
\upicture{\upath/Pictures/img-chapvar}{Synthèse des meta-processus SECOPS}{0.9}{lbl_prosecops}
