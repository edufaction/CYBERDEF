...
\begin{block}{Menaces=Évènements}
   La détection d'une vulnérabilité ou d'une menace est un évènement, la question est de savoir à quel moment il est important de déclencher un mécanisme d'alerte, et comment cette alerte va devenir un incident déclenchant des mécanismes de réponse \uref{Cycle de gouvernance}{lbl-cycle3}.
\end{block}
...
% end header PRZ =======================
\upicture{../Tex/Pictures/img-cycle3}{Cycle de vie de gouvernance Cyberdef}{1}{lbl-cycle3}
\end{frame}
% end PRZ ===========================
...
% end header PRZ =======================
\upicture{../Tex/Pictures/img-var}{Un modèle de gestion cyberdefense}{1}{lbl-threatman}
\end{frame}
% end PRZ ===========================
...
En outre, sur le triptyque Vulnérabilités, Menaces, Incidents \uref{Modèle de cyberdéfense}{lbl-threatman}. la notion d'attaque interne et/ou externe n'a de sens qu'au titre de la responsabilité du périmètre, car rien n'interdit de positionner des capteurs en dehors de son périmètre technique pour anticiper la menace. Ainsi, la veille sur internet, le renseignement cyber sont nécessairement équipés de capteurs pouvant faire remonter des événements dans des chaines d'alertes Cyber.
...
% end header PRZ =======================
\upicture{../Tex/Pictures/img-threatrosas}{les 4 axes de la gestion de la menace}{1}{lbl-threatrosas}
\end{frame}
% end PRZ ===========================
...
% end header PRZ =======================
\upicture{../Tex/Pictures/img-varmenaces}{la gestion de la menace}{0.5}{lbl-varmenaces}
\end{frame}
% end PRZ ===========================
...
% end header PRZ =======================
\upicture{../Tex/Pictures/img-threatwheel}{la gestion de la menace}{0.7}{lbl-threatwheel}
\end{frame}
% end PRZ ===========================
\begin{itemize}
...
\frametitle<presentation>{La gestion de la menace}
% end header PRZ =======================
\upicture{../Tex/Pictures/img-logman}{la gestion de la menace}{0.8}{lbl-logman}
