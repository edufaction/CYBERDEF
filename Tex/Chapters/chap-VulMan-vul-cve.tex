...
\subsection{Common Weakness Enumeration (CWE)}
 ...
 L'Énumération des faiblesses ordinaires c'est ainsi qu'il faudrait traduire CWE publié par le \link{http://cwe.mitre.org}{MITRE}  est un site qui liste par ailleurs le top 25 des  erreurs de programmation dangereuses et fréquentes. 
