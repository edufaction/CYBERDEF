...
Parmi ces vulnérabilités les plus célèbres (voir figure~\ref{lbl_faillesmb}), la classe de vulnérabilités du protocole SMB en version 1, est celle qui continue encore a faire des victimes.
...
% end header PRZ =======================
\upicture{../Tex/Pictures/zerodium}{Le marché des failles mobiles avec Zerodium}{0.7}{lbl_zerodium}
\end{frame}
% end PRZ ===========================
