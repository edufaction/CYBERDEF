...
Il y a en effet une grande différence de métiers, de compétences entre un spécialiste de la gestion des accès  qui conduira l'intégration de système d'IAM  \footnote{Identity et Access Management} et un \g{ethical hacker } qui devra rechercher des scenarii d'attaques potentielles sur un système. 
