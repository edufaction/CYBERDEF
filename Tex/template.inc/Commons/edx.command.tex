...
{{\huge\ccbyncndeu}}  \\  
{2020 eduf@ction Publication en \href{https://creativecommons.org/licenses/by-nc-nd/2.0/fr/}{Creative Common BY-NC-ND} }    \\  % Copyright notice
...
\includegraphics[width=0.9\textwidth]{SecTools/#2.#1/icon.png} \\
\tcblower
...
%-----------------------------------------------------
  ...
  \newcommand{\utodo}{\begin{center}{\noindent \textcolor{cyan}{\faGears~{chapitre en travaux - éléments non publiés} \faGears}}\end{center}}
  
  \newcommand{\utocomplete}{\noindent Chapitre en cours de rédaction, à compléter}
