...
% (PicframeS)
\newcommand{\picpath}{Tex/Pictures}
%-------------------------------------------------------------
...
sharp corners, 
  ...
  coltitle = ocre!20!black,
  fonttitle = \bfseries, 
  title    =  {\textcolor{ocre}{\faFile~\small {Fiche Techno-Blog}}} : #2,
  #1,
}
...
\frametitle<presentation>{#2}
  \begin{center}
	 \includegraphics[height=0.95\textheight, width=0.95\textwidth, keepaspectratio ]{\picpath/img-#1.pdf}
  \end{center}
\end{frame}
...
{
\begin{figure}[!hbtp] % !hbtp ou !h 
\centering \includegraphics[width=#3\textwidth]{\picpath/img-#1.pdf}
