...
%\renewcommand{\rmdefault}{phv} % text 
...
%\draw[anchor=west] (\Gm@lmargin+.3cm,-9cm) node {\huge\sffamily\bfseries\color{ocre}\hyperlink{\thechapter\autodot~#1}{#1}\strut }};
\draw[anchor=west] (\Gm@lmargin+.3cm,-9cm) node {\huge\sffamily\bfseries\color{ocre}\thechapter\autodot~#1\strut};
