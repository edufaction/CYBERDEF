...
\node at (current page.center)  [xshift=0cm, yshift=6cm, text opacity=1.0]  { \includegraphics[width=0.2\paperwidth]{\upath/template.inc/CourseModel/CoursePictures/shield-20-white.pdf}} ; 
